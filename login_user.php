...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <h6>Untuk Login <b>Admin</b> Klik dibawah ini !</h6>
        ...
        <div class="card">
            <div class="card-body login-card-body">
                <div class="text-center mb-3">
                    <img src="logo/logo.jpeg" alt="" width="200">
                </div>
                <div class="text-center mb-3">
                    <h6>Sewa Playstation</h6>
                    <h6> Bang Jack Nanga Merakai</h6>
                </div>
                <form method="post" role="">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <a href="daftar_user.php" name="login" class="btn btn-secondary btn-block mt-2">Daftar User</a>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
