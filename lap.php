                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <form action="lap.php" method="get">
                                               ...
                                               if (isset($_GET['dari'])){?>
                                                <div class="col-lg-12">
                                                <h5>Berikut ini adalah hasil Pencarian Mulai Tanggal <b><?php echo date('d F Y', strtotime($_GET['dari']))  ?></b> hingga <b><?php echo  date('d F Y', strtotime($_GET['ke'])) ?></b> , <i><a href="lap_cetak_perbulan.php?dari=<?php echo $_GET['dari'] ?>&&ke=<?php echo $_GET['ke'] ?>">Klik disini untuk mencetak data</a></i></h5>
                                               </div>
                                               <?php }else {
                                                ...
                                                <?php $nomor = 1; ?>
                                                    <?php 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                <a href="konfir_order.php?id=<?php echo $d['id_sewa'] ?>" class="btn btn-primary btn-sm">Lihat</a>
                                                                <a href="konfir_order_cetak.php?id=<?php echo $d['id_sewa'] ?>" class="btn btn-warning btn-sm">Cetak</a>
                                                                </td>
                                                            </tr>
