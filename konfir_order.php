                                            ...
                                            <table class="table table-bordered">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                            <?php echo $pecahsewa['estimasi'] ?> Bulan
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>:</td>
                                                        <td>
                                                        <?php echo $pecahsewa['sewa_akhir'] ?> WIB
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <?php 
                                                            $query_tb_barang = $koneksi->query("SELECT * FROM tb_barang");
                                                            if ($query_tb_barang) {
                                                                if ($query_tb_barang->num_rows > 0) {
                                                                    while ($row_tb_barang = $query_tb_barang->fetch_assoc()) {
                                                                        $id_ps = $row_tb_barang['id_ps'];
                                                                        if ($id_ps == 13) {
                                                                            $totalbayar = $pecahsewa['estimasi'] * 400000;
                                                                        } elseif ($id_ps == 14) {
                                                                            $totalbayar = $pecahsewa['estimasi'] * 400000;
                                                                        } elseif ($id_ps == 15) {
                                                                            $totalbayar = $pecahsewa['estimasi'] * 400000;
                                                                            ...
                                                                            $totalbayar = $pecahsewa['estimasi'] * 450000;
                                                                        } elseif ($id_ps == 19) {
                                                                            $totalbayar = $pecahsewa['estimasi'] * 450000;
                                                                        } elseif ($id_ps == 20) {
                                                                            $totalbayar = $pecahsewa['estimasi'] * 450000;
                                                                            ...
                                                                            $totalbayar = $pecahsewa['estimasi'] * 500000;
                                                                        }
                                                                    }
                                                                }
                                                            }
